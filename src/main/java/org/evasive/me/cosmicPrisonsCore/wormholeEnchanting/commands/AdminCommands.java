package org.evasive.me.cosmicPrisonsCore.wormholeEnchanting.commands;
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String @NotNull [] strings) {
        ...
        if(strings.length == 1 && strings[0].equals("all")){
            for (PickaxeEnchants pickaxeEnchants : PickaxeEnchants.values()){
                player.getInventory().setItemInMainHand(new PickaxeEnchantFunctions().addEnchant(player.getInventory().getItemInMainHand(), pickaxeEnchants.wormholePickaxeEnchantBuilder().getEnchant(), pickaxeEnchants.wormholePickaxeEnchantBuilder().getMaxLevel()));
            }
        }
        ...
        if(strings.length == 2){
            ...
            player.getInventory().setItemInMainHand(new PickaxeEnchantFunctions().addEnchant(player.getInventory().getItemInMainHand(), PickaxeEnchants.valueOf(strings[0]), Integer.parseInt(strings[1])));
        }
